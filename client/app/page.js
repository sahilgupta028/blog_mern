...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col font-serif bg-gradient-to-br from-blue-900 to-purple-900">
  <div className="flex flex-row justify-between items-center">
    ...
    <div className="flex px-5 py-5 justify-around">
      <Link href="/posts">
        <button className="m-4 bg-yellow-400 p-5 rounded-lg flex flex-row text-slate-950 hover:bg-yellow-500 transition-all duration-300">
  ...
  <div className=" flex flex-col items-center m-28">
    ...
    <Link href="/login">
  <button className="m-10 bg-yellow-400 p-5 rounded-lg flex flex-row text-slate-950 hover:bg-yellow-500 transition-all duration-300">
